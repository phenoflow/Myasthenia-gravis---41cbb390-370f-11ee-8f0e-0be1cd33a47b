...
(async () => {
  ...
  await fs.writeFile("myasthenia-gravis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("myasthenia-gravis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
